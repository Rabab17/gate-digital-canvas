...
const translations = {
  en: {
    ...
    'services.digitalMarketing.description': 'Strategic campaigns that increase visibility, drive engagement, and convert leads across  platforms.',
    ...
    'services.webDevelopment.description': 'Custom websites that blend stunning design with  functionality to deliver exceptional user experiences.',
    ...
    'services.branding.description': ' branding solutions that establish a strong market presence and foster lasting customer connections.',
    ...
    'contact.egypt': 'Egypt',
    "contact.cairoAddress":"Eypt (Cairo /3Makram Ebeid St., Intersection with Mostafa El-Nahas St., Nasr City)",
    'contact.fayoumCairo': '(Al Fayoum - Al-Masalla, 15 Street (Resala Association Street), Al-Wafa Tower)',
...
"contact.cairoAddress":"القاهرة / ٣ شارع مكرم عبيد، تقاطع شارع مصطفى النحاس، مدينة نصر",
    'contact.egypt': 'مصر',
    'contact.fayoumCairo': ' (الفيوم - المسلة، ش 15 (ش جمعية رسالة)، برج الوفا) ',
