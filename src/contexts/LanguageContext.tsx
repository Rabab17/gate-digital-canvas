...
/////
    ...
    'contact.description': 'هل لديك مشروع أو ترغب في معرفة المزيد؟ يسعدنا التواصل معك. فقط املأ النموذج أو تواصل معنا عبر معلومات الاتصال أدناه.',
    'contact.locations': 'المواقع',
    'contact.egypt': 'مصر',
    'contact.fayoumCairo': 'الفيوم / القاهرة',
    'contact.saudi': 'السعودية',
    'contact.riyadh': 'الرياض',
    'contact.uae': 'الإمارات',
    'contact.dubai': 'دبي',
