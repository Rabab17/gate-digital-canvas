...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        {/* أزلنا "order-1" و "order-none" من هنا */}
        ...
        <nav className="hidden lg:flex items-center space-x-1">
          {/* Main Nav Items */}
          {/* هنا قمنا بإزالة space-x-reverse. الترتيب سيعتمد على الـ navItems */}
          <ul
            className={`flex ${
          ...
          <div
            className={`flex items-center gap-3 ml-6 ${
              language === "ar" ? "mr-6 ml-0" : "ml-6" // أزلنا order-first
            }`}
          >
            <ThemeToggle />
            <LanguageToggle />
      ...
      >
        <ul className="px-4 py-6 space-y-2">
          ...
          <li className={`pt-4 border-t border-gray-200 dark:border-gray-700`}>
            ...
            <div
              className={`flex items-center justify-center gap-4 mb-4`} // أزلنا الشرط الخاص باللغة هنا لأنه لا يؤثر
            >
              <ThemeToggle />
              <LanguageToggle />
            </div>
