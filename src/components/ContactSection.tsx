      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-bold text-lg mb-2">Locations</h4>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <span className="font-medium">Phone:</span> +20 123 456 7890
                  </p>
                </div>
              </div>
        ...
        <div className="mt-12 h-80 rounded-lg overflow-hidden">
          ...
          <div className="w-full h-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
            <p className="text-gray-500 dark:text-gray-400">Google Maps will be embedded here</p>
          </div>
        </div>
      </div>
    </section>
